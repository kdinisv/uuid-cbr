...
Пакет для Node.js формирует УИд по требованиям Банка России (CBR) на основе UUID v1 с контрольным символом и повторяет поведение официального примера на C.
